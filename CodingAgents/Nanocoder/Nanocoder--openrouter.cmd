...
REM
REM  Nanocoder reads OPENROUTER_API_KEY natively and accepts
REM  --provider openrouter --model <slug> on the command line.
...
set "ORIG_DIR=%CD%"
pushd "%~dp0"
echo Launching Nanocoder via OpenRouter model: %OPENROUTER_MODEL%
call nanocoder --provider openrouter --model "%OPENROUTER_MODEL%"
popd
goto :end
