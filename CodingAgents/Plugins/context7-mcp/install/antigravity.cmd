...
REM ============================================================
REM  context7-mcp -> Antigravity  (install hook)
REM  ------------------------------------------------------------
...
set "MARKER=%MARKER_DIR%\context7-mcp.Antigravity.installed"
set "SETTINGS=%USERPROFILE%\.antigravity\settings.json"

if exist "%MARKER%" (
    echo   context7-mcp already registered with Antigravity ^(marker present^).
    exit /b 0
)
...
if errorlevel 1 (
    ...
    echo   but Antigravity will not be able to launch context7
